        ...
        tabFormat: {
            ...
            illuminati: {
                ...
                content:[
                    ...
                    ["microtabs", "stuff", {'width': '1000px', 'height': "550px", 'background-color': 'blue', 'border-style': 'solid'}],
                    ["display-text", "Adjust how many points TH divides you!"],
                    ["slider", ["otherThingy", 0.01, 30]], "blank", ["upgrade-tree", [[11], 
                    [12, 22, 22, 11]]]
                ]
            },
            Multiverse: {
...
addLayer("f", {
    ...
    midsection: [
        "blank", ["resource-display"], ['display-image', 'https://images.beano.com/store/24ab3094eb95e5373bca1ccd6f330d4406db8d1f517fc4170b32e146f80d?auto=compress%2Cformat&dpr=1&w=390'],
        ["display-text", "Bork bork!"],
        ['display-image', 'https://images.beano.com/store/24ab3094eb95e5373bca1ccd6f330d4406db8d1f517fc4170b32e146f80d?auto=compress%2Cformat&dpr=1&w=390'],
        ["display-text", "Bork bork!"],
        
    ],
    // The following are only currently used for "custom" Prestige type:
    prestigeButtonText() { //Is secretly HTML
        if (!this.canBuyMax()) return "Hi! I'm a <u>weird dinosaur</u> and I'll give you a Farm Point in exchange for all of your points and lollipops!"
...
addLayer("b", {
        ...
        width: 500,
        height: 50,
        progress() { return player.b.points.add(1).log10().div(10) },
